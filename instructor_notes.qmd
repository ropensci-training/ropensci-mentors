...
> We will see toosl for your role as mentor and logistic about the program. We will also shared resources we build for you, to help you with your role. 
...
::: {.callout-tip}
## Recording
If you will record the sesion, this is a good time to ask for permission. Be clear on how you will use the recording and with who you will share. 
:::
...
Finished this section with slide twelve with a summary for GROW model. 
 
### Mentor tools. Program logistics 

The next session introduce the Mentors Guidelines and others infrastructure and tools we developed for the champions program. 

Shared the slide 13, mention each tool and then show the tools.  The most important one is the Mentors Guidelines. Open the document and go trough it showing the section, the resources and information we gather there for them.

Clic on the link to the other resources to also show them: google drive, slack and meeting templates.

::: {.callout-tip}
## Cheking for Access
This is a good time to check for access to these resources: are all in Slack and in the rigth channels? Do you have access to the google drive and the google docs? Can you copy the meeting templates?, can you access the meeting report form?
:::

Now it is time for the next exercise, with the prompt "Are you ready for mentor?" we provide space to comments and to question and clarifications mentors need.  Allow them to speak or write on the shared document or the chat.  If they ask on the chat, copy those comment on the shared doc.  This questions can be useful for the other cohorst. The time for this activity is 10 minutes, but take more minutes if they have good questions about the mentoring role or about the program.  

The final exercise calls mentors to practice give a constructive feedback filling an anonymous feedback survey about the trainig. Share the link to the form on the chat or mention they can access the link on the shared note.  Give 5 minutes to fill the survey.

::: {.callout-tip}
## Cheking completion
For this final exercise you can also ask students to write on the chat "Done!" or "Finish!" or something similar when they finished.  This way you will know and you can end the activity when all are done.  Some times this can mean before the time allocate for the exercise.
:::


## Post-training

After the training send a message (email, Slack) thanking those who attended and re-sharing important resources:
...
- The feedback survey (for a second change to fill)
