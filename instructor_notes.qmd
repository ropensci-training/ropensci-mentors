...
_"You will work in groups for the next exercise. You will have 10 minutes to watch the video linked in the shared doc. It is an example using the GROW model. The idea is you try to identify the steps of the model. You can re-watch the video or stop, answer, and then continue. Please use the shared doc on your group space to write your questions._

_"When you finish, we will discuss your answer with the whole group."_

You can create random groups, with no more than 3-4 people in each group. Read their answer during the exercise and choose some groups to share with the whole class. Choose this group because they add something interesting or different to the discussion. If you have a few groups, give all of them a chance to share their insight. 


::: {.callout-note}
If you are traching the _120_ minutes version of the trainig it is time of a 5/10 minutes break away from the screen. 
:::
